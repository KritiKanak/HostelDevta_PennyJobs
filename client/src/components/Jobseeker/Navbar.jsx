      ...
      <Toolbar>
        ...
        {isMobile ? (
            ...
            <Drawer anchor="right" open={drawerOpen} onClose={handleDrawerToggle}>
              <List className={classes.drawer}>
                ...
                {!localStorage.getItem('token') ? (
                  <>
                    <ListItem button component={Link} to="/candidate" selected={location.pathname === '/candidate'}>
          ...
          <>
            ...
            {!localStorage.getItem('token') ? (
              <>
                <Button color="inherit" component={Link} to="/candidate" className={location.pathname === '/candidate' ? 'active' : ''}>
                  Login
                </Button>
                <Button color="inherit" component={Link} to="/candidate" className={location.pathname === '/candidate' ? 'active' : ''}>
                  SignUp
